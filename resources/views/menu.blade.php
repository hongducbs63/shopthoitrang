...
<body class="tp_background tp_text_color">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="title-main text-center">
                        <h1 class="title-hd"><a href="#">{{$menu->name}}</a></h1>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="footer-bottom">
                        <div class="row">
                            <div class="col-md-6">
                                <span>@Copyright 2022 all rights reserved. Thiết kế bởi HongDuc</span>
                            </div>
                            <div class="col-md-6">
    ...
    <div id="modalAbandoned" class="modal fade right" tabindex="-1" role="dialog"
